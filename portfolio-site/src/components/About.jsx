  ...
  const aboutContent = [
    {
      ...
      text: (
        <>
          ...
          <p>Since then, I've been working on personal projects to advance my skills and taking another online course from home to learn more advanced concepts and learn React.js. The more I learn and the more I progress make me super excited to dive into a web developer role.</p>
    ...
    },
    {
      ...
      text: (
        <>
          <p>Hey, I'm Morton, a 27 year old web developer originally from a small village called Llangrannog in West Wales. Over a year ago, I made the exciting move to London to pursue a career in web development. Let me share a bit about my journey.</p>
