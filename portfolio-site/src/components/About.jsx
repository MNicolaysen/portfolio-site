  ...
  const aboutContent = [
    {
      ...
      text: (
        <>
          <div className='sheet'>
            <p className='sheet-text'>Hey, I'm Morton, a 27-year-old aspiring web developer living in London. I made the move here a little over a year ago to pursue a career as a web developer. I wasted no time and jumped right into a fullstack web developer bootcamp with Le Wagon, which was the best intro into web development I could have asked for.</p>
            <p className='sheet-text'>Since then, I've been working on personal projects to advance my skills and taking another online course from home to learn more advanced concepts and learn React.js. The more I learn and the more I progress make me super excited to dive into a web developer role.</p>
